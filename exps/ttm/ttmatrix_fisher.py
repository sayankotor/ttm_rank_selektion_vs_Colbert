...
from .ttensor_custom import CustomTensor
...
class TTMatrix:
    ...
    def __init__(
            ...
            is_from_weight: Optional[bool] = False #should we run proper rank calculation
        ):
        '''
        ...
        tt = CustomTensor(tensor, ranks_tt=ranks, batch=self.batch, is_from_weight = is_from_weight)
